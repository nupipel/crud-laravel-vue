...
(() => {
/*!**************************************************!*\
  !*** ./src/assets/js/extensions/parsley.init.js ***!
  \**************************************************/
var _$$extend;
...
$.extend(window.Parsley.options, (_$$extend = {
  focus: 'first',
...
}, _defineProperty(_$$extend, "errorsContainer", function errorsContainer(el) {
  return el.$element.closest('.form-group');
}), _defineProperty(_$$extend, "errorsWrapper", '<div class="parsley-error"></div>'), _defineProperty(_$$extend, "errorTemplate", '<span></span>'), _$$extend));
